...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { bt_submit }]; #IO_L4N_T0_D05_14 Sch=btnu
...
## Red Green LEDS
#set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { GREEN_LED }]; #IO_L10P_T1_D14_14 Sch=GREEN_LED
#set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { RED_LED }]; #IO_L11P_T1_SRCC_14 Sch=RED_LED
